...
const MobileNav = () => {
  ...
  return (
    <>
      <div
        className="header block md:hidden min-h-[462px] bg-cover bg-no-repeat bg-center"
        style={{ backgroundImage: `url(${headerBG})` }}
      >
        <div
          className={`${
            color ? "bg-white" : "desktop-nav"
          } navigation flex justify-between items-center tmx-auto py-4 px-3 fixed top-0 inset-x-0 transition-all z-10`}
        >
